                                      ...
                                      if (scheduleState is ScheduleLoading) {
                                        ...
                                        return Container(
                                          child: Container(
                                              ...
                                              height: 150,
                                              child: selectedDaySchedules.isEmpty ? Center(child: TrainingTextContainer(selectedDay: selectedDay == null ? kToday : selectedDay, kToday: kToday,)) : SingleChildScrollView(
                                                  child: Column(
                                                    children: [
                                                      ListView.builder(
                                                        shrinkWrap: true,
